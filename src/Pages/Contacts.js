...
const Contacts = () => {
  const handlemesage = () => {
    if (
      ...
      toast.error(
        "Opa !! Verifique se todos os campos estão preenchidos e tente novamente ."
      );
    } else {
  ...
  return (
    ...
    >
      ...
      <Container>
        {window.document.body.clientWidth >= 851 ? (
          <Box row justify="space-between">
            <Box
              cursor
              paddingTop={1}
            ...
            <Container>
              ...
              >
                <Box className="boxcontactstitle">
                  ...
                  <Box top={10}>
                    <img
                      src={window.document.body.clientWidth > 850 ? logoon : ""}
